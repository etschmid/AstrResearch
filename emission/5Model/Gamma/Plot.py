...
atmosphere = Radtrans(line_species = ['H2O', 'CO_all_iso', 'CH4', 'CO2', 'NH3', 'H2S', 'Na', 'K'], \
      rayleigh_species = ['H2'], \
...
press, temperature = nc.make_press_temp(temp_params)
...
mass_fractions1['Na'] = 33e-6 * np.ones_like(temperature)
mass_fractions1['K'] = 33e-6 * np.ones_like(temperature)
...
if(plot_select[0]==1):
    ...
    with open('Solar1_Profile.csv', 'w') as csv_file:
